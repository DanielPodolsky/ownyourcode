/* ════════════════════════════════════════════════════════════════════
   ...
   ── This is the SCAFFOLD. Run /own:init to replace it with your project. ──
   ════════════════════════════════════════════════════════════════════ */
window.PROJECT = {
  meta: {
    name: "Your Project",
    tagline: "run /own:init to begin",
    audience: "myself",
  ...
  phases: [],  // roadmap phases — see DASHBOARD_CONTRACT §3.4 for the shape
};
